...
class SnakeGame:
    ...
    def draw(self):
        ...
        for i, (x, y) in enumerate(self.snake):
            color = GREEN if i == 0 else WHITE  # Head is brighter
            pygame.draw.rect(self.screen, color, (x * GRID_SIZE + 1, y * GRID_SIZE + 1, GRID_SIZE - 2, GRID_SIZE - 2))
        
        # Draw food
        fx, fy = self.food
        pygame.draw.rect(self.screen, RED, (fx * GRID_SIZE + 1, fy * GRID_SIZE + 1, GRID_SIZE - 2, GRID_SIZE - 2))
